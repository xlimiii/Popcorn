...
class PersonDetailsAdapter(var moviesInPerson: LiveData<List<Movie>>) : RecyclerView.Adapter<PersonDetailsAdapter.PersonHolder>() {
    ...
    override fun onBindViewHolder(holder: PersonDetailsAdapter.PersonHolder, position: Int) {
        ...
        val movieRowBackground = holder.itemView.findViewById<LinearLayout>(R.id.actorRowBackground)
