...
class CrewAdapter(var moviesInPerson: LiveData<List<GeneralObject>>, val movieVM: MovieViewModel) : RecyclerView.Adapter<CrewAdapter.PersonHolder>() {
    ...
    override fun onBindViewHolder(holder: PersonHolder, position: Int) {
        ...
        character.text = moviesInPerson.value?.get(position)?.department
